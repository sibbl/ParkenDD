...
using ParkenDD.Win10.Converter.Json;
using ParkenDD.Win10.Models;
using ParkenDD.Win10.Models.Exceptions;
...
namespace ParkenDD.Win10.Services
{
    public class ApiService : IApiService
    {
        ...
        public Task<MetaData> GetMeta(CancellationToken? ct = null)
        {
        ...
        /// <param name="ct">cancellation token</param>
        /// <returns>parsed server response</returns>
        public Task<City> GetCity(string cityId, CancellationToken? ct = null)
        {
            return Request<City>(
                requestUri: cityId,
                cancellationToken: ct
